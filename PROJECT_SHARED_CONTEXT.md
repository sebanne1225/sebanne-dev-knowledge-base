...
- repo 固有なら AGENTS / config ではなく `CODEX_HANDOFF.md` に寄せ、候補判定はスレッド終了時に行う。迷ったらまず knowledge repo に残し、AGENTS 追加は保留する
...
- 最初の Skill は診断専用で始め、repo 固有例外は Skill に飲み込まず、まず `CODEX_HANDOFF.md` に逃がす
